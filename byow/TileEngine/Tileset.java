...
public class Tileset {
    // @source Dominic Paragas (Brocolli tile)
    public static final TETile NOTHING = new TETile('v', new Color(86, 26, 25), new Color(0, 16, 25), "broccoli", "./byow/TileEngine/images/broccoli_google.png");
...
//    public static final TETile WALL = new TETile('#', new Color(216, 128, 128), Color.darkGray, "wall");
    ...
    public static final TETile FLOOR = new TETile('·', new Color(128, 192, 128), Color.black,
            "floor");
    public static final TETile ROOM = new TETile('·', new Color(224, 115, 75), Color.black,
            "room but no difference from hallway at bkl");
